...
from utils.models import BaseModel,UserProfile
from hr.models import Employee
# Create your models here.


class Attendance(models.Model):
	employee           = models.ForeignKey(Employee, blank=False, null=False, related_name = "emplyee_attendance", on_delete=models.CASCADE)
	...
	def __str__(self):
		return '{}, {}'.format(self.employee,self.enterance_time)
